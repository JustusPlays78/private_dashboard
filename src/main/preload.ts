...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  tools: {
    getStatus: () => ipcRenderer.invoke('tools:getStatus'),
    download: (toolName: string) => ipcRenderer.invoke('tools:download', toolName),
    isInstalled: (toolName: string) => ipcRenderer.invoke('tools:isInstalled', toolName),
  }
})
