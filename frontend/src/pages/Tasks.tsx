        ...
        <div className="px-4 py-6 sm:px-0">
            <div className="mb-8 flex justify-between items-center">
                <div>
                    ...
                    <p className="mt-2 text-secondary">Verwalte deine Aufgaben und To-Dos</p>
                </div>
                <button
                        ...
                        <div className="flex-1">
                            ...
                            {task.due_date && (
                                <div className={`flex items-center mt-2 text-sm ${
                                    isOverdue ? 'text-red-400' : task.completed ? 'text-muted' : 'text-secondary'
                                }`}>
                                    <Calendar className="w-4 h-4 mr-1" />
                                    Fällig: {format(new Date(task.due_date), 'dd.MM.yyyy HH:mm', { locale: de })}
                                    {isOverdue && <span className="ml-2 font-medium" style={{ color: 'var(--accent-red)' }}>(Überfällig)</span>}
                                </div>
                            )}
