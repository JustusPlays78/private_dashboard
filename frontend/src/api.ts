...
export const tasksApi = {
    ...
    create: async (task: Omit<Task, 'id' | 'created_at' | 'updated_at' | 'completed' | 'subtasks'>): Promise<Task> => {
        const response = await fetch(`${API_URL}/tasks`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    updateSubtask: async (taskId: string, subtaskId: string, updates: { completed?: boolean; title?: string }): Promise<Subtask> => {
...
export const scriptsApi = {
    ...
    update: async (id: string, script: Omit<Script, 'id' | 'created_at' | 'updated_at'>): Promise<Script> => {
        const response = await fetch(`${API_URL}/scripts/${id}`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(script),
    ...
    execute: async (id: string, variables: { [key: string]: string }): Promise<ScriptResult> => {
